...
class WhereFilter(RootModel[Union[LogicalFilter, Dict[str, FilterOp]]]):
    ...
    def reject_mixed_logical_and_field(cls, data: Any) -> Any:
        # A filter is either logical (AND/OR/NOT) or a set of field filters,
        # never both in one object. Mixing them would otherwise resolve to the
        # logical branch and silently drop the field filters.
