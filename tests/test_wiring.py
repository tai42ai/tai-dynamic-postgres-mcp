...
def test_vector_loader_parses_literal():
    from tai42_mcp_dynamic_postgres.database.helpers import VectorLoader
...
def test_register_json_dumpers_registers_dict():
    from tai42_mcp_dynamic_postgres.database.helpers import register_json_dumpers
...
async def test_register_vector_warns_when_missing(monkeypatch):
    import tai42_mcp_dynamic_postgres.database.helpers as helpers_mod
